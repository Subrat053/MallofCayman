...
const ShopCreate = () => {
  ...
  // Store Manager Service option (SRS: Can be purchased during Vendor registration)
  const [wantStoreManager, setWantStoreManager] = useState(false);
  const STORE_MANAGER_PRICE = 100; // USD
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Include Store Manager service preference
      if (wantStoreManager) {
        newForm.append("wantStoreManager", "true");
      }
        ...
        <div className="max-w-3xl mx-auto pt-16">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              {/* Store Manager Service Option - SRS 3.2: Can be purchased during registration */}
              <div className="mt-6 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-200">
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    name="storeManager"
                    type="checkbox"
                    checked={wantStoreManager}
                    onChange={(e) => setWantStoreManager(e.target.checked)}
                  ...
                  <div className="flex-1">
                    <label
                      ...
                      className="flex items-center text-sm font-semibold text-emerald-800 cursor-pointer"
                    >
                      <FiUsers className="mr-2 text-emerald-600" />
                      Add Store Manager Service
                      <span className="ml-2 px-2 py-0.5 bg-emerald-200 text-emerald-700 text-xs font-bold rounded-full flex items-center">
                        <FiDollarSign size={12} className="mr-0.5" />
                        {STORE_MANAGER_PRICE} USD
                      </span>
                    </label>
                    <p className="text-xs text-emerald-700 mt-2 leading-relaxed">
                      Delegate day-to-day operations to a Store Manager who can:
                    </p>
                    ...
                    {wantStoreManager && (
                      <div className="mt-3 p-2 bg-white/60 rounded-lg border border-emerald-200">
                        <p className="text-xs text-emerald-700">
                          <strong>Note:</strong> You'll be redirected to PayPal
                          after registration to complete the $
                          {STORE_MANAGER_PRICE} payment. You can also purchase
                          this service later from your dashboard.
                        </p>
                      </div>
                    )}
                  </div>
