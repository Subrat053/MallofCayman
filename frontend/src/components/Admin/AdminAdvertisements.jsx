...
const AdminAdvertisements = () => {
  ...
  return (
    <div className="w-full mx-2 sm:mx-4 800px:mx-8 pt-1 mt-4 sm:mt-10 bg-white rounded-lg shadow-md">
      ...
      {/* Summary Cards */}
      <div className="grid grid-cols-2 sm:grid-cols-3 800px:grid-cols-6 gap-2 sm:gap-4 p-3 sm:p-6 border-b">
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-2 sm:p-4 rounded-lg border-l-4 border-orange-500">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-2 sm:p-4 rounded-lg border-l-4 border-gray-500">
          <div className="text-[10px] sm:text-sm text-gray-600 mb-1">
            Expired
          </div>
