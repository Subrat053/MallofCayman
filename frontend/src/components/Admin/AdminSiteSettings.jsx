    ...
    <div className={classes.root}>
        ...
        <CardContent className={classes.headerContent}>
          ...
          >
            <div>
              ...
              >
                Configure footer, company info & social links
              </Typography>
              {lastUpdated && (
                <Typography
                  variant="caption"
      ...
      <Card className={classes.sectionCard}>
        <Box className={classes.sectionHeader}>
          <PaletteIcon
            style={{ marginRight: 8, color: "#667eea", fontSize: 20 }}
          />
          <Typography
            variant="h6"
            style={{ fontWeight: 600, fontSize: "clamp(0.9rem, 3vw, 1.25rem)" }}
          >
            Branding & SEO
          </Typography>
        </Box>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={8}>
              <TextField
                ...
                placeholder="e.g., 5-25, 15th main road, 3rd stage"
                multiline
                rows={2}
              />
            </Grid>
      ...
      <Card className={classes.sectionCard}>
        <Box className={classes.sectionHeader}>
          <BusinessIcon
            style={{ marginRight: 8, color: "#10b981", fontSize: 20 }}
          />
          <Typography
            variant="h6"
            style={{ fontWeight: 600, fontSize: "clamp(0.9rem, 3vw, 1.25rem)" }}
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Box display="flex" alignItems="center">
                <input
                  ...
                  style={{ marginRight: 8 }}
                />
                <Typography variant="body2">Enable PayPal</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                className={classes.textField}
                size="small"
                value={settings.paymentSettings?.paypalMode || "sandbox"}
                onChange={(e) =>
                  handleInputChange(
                    "paymentSettings",
                    "paypalMode",
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Box display="flex" alignItems="center">
                <input
                  ...
                  style={{ marginRight: 8 }}
                />
                <Typography variant="body2">Enable Stripe</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Box display="flex" alignItems="center">
                <input
                  type="checkbox"
                  checked={settings.paymentSettings?.codEnabled || false}
                  onChange={(e) =>
                    handleInputChange(
                      "paymentSettings",
                      "codEnabled",
                  ...
                  style={{ marginRight: 8 }}
                />
                <Typography variant="body2">Enable Cash on Delivery</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <Box display="flex" alignItems="center">
                <input
                  type="checkbox"
                  checked={settings.paymentSettings?.taxEnabled || false}
                  onChange={(e) =>
                    handleInputChange(
                      "paymentSettings",
                      "taxEnabled",
                  ...
                  style={{ marginRight: 8 }}
                />
                <Typography variant="body2">Enable Tax</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                size="small"
                type="number"
                value={settings.paymentSettings?.minimumOrderAmount || 0}
                onChange={(e) =>
                  handleInputChange(
                    "paymentSettings",
                    "minimumOrderAmount",
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                size="small"
                type="number"
                value={settings.paymentSettings?.taxRate || 0}
                onChange={(e) =>
                  handleInputChange(
                    "paymentSettings",
                    "taxRate",
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                size="small"
                type="number"
                value={settings.paymentSettings?.commissionRate || 10}
                onChange={(e) =>
                  handleInputChange(
                    "paymentSettings",
                    "commissionRate",
                ...
                inputProps={{ min: 0, max: 100 }}
                helperText="Commission taken from seller orders"
              />
            </Grid>
          </Grid>
        </CardContent>
