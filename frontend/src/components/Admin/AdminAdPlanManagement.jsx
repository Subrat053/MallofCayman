        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div>
            ...
            <p className="text-purple-100 text-xs sm:text-sm mt-1">
              Configure ad types, pricing & discounts
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4">
            <h3 className="text-base sm:text-lg font-bold text-gray-800 flex items-center">
              <MdDiscount className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-green-600" />
              Duration Discounts
            </h3>
            {editingDiscount ? (
              <div className="flex gap-2">
                <button
                  ...
                  disabled={saving}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-1 text-sm"
                >
                  <AiOutlineSave /> Save
                </button>
                <button
                  onClick={() => setEditingDiscount(null)}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 flex items-center gap-1 text-sm"
                >
              ...
              <button
                ...
                className="px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-1 text-sm"
              >
                <AiOutlineEdit /> Edit
              </button>
            )}
                ...
                <div className="text-center">
                  ...
                  {editingDiscount ? (
                    <input
                      ...
                      className="w-14 sm:w-20 text-center text-xl sm:text-2xl font-bold mt-2 border border-gray-300 rounded-lg"
                    />
                  ) : (
                    <div
        ...
        <div>
          <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-4 flex items-center">
            <BiDollar className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-blue-600" />
            Ad Types & Pricing
          </h3>
            ...
            <table className="w-full border-collapse min-w-[800px]">
              <thead>
                <tr className="bg-gray-100">
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-700 border-b">
                    Status
                  </th>
        ...
        {/* Info Section */}
        <div className="mt-6 sm:mt-8 bg-blue-50 border border-blue-200 rounded-lg sm:rounded-xl p-3 sm:p-6">
          <h4 className="font-bold text-blue-800 mb-2 sm:mb-3 text-sm sm:text-base">
            📋 Ad System Rules
          </h4>
        ...
        {/* Free Mode Warning */}
        <div className="mt-4 bg-purple-50 border border-purple-200 rounded-lg sm:rounded-xl p-3 sm:p-6">
          <h4 className="font-bold text-purple-800 mb-2 sm:mb-3 flex items-center gap-2 text-sm sm:text-base">
            <BsGift className="w-4 h-4 sm:w-5 sm:h-5" />
            🧪 Free Mode (Testing)
          </h4>
