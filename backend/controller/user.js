  ...
  try {
    ...
    try {
      ...
      if (template) {
        ...
        emailSubject = "Activate Your Account - Mall of Cayman";
        emailHtml = `
          <!DOCTYPE html>
          <html>
          <head>
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                      <td style="padding: 40px;">
                        <h2 style="margin: 0 0 20px 0; color: #1f2937; font-size: 24px;">Hello, ${user.name}! 👋</h2>
    ...
    try {
      ...
      try {
        ...
        if (template) {
          ...
          // Fallback to default styled HTML if template not found
          emailSubject = "Reset Your Password - Mall of Cayman";
          emailHtml = `
            <!DOCTYPE html>
            <html>
            <head>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                      ...
                      <tr>
                        <td style="padding: 40px;">
                          ...
                          <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                            We received a request to reset your password for your Mall of Cayman account. Click the button below to create a new password:
                          </p>
                          <!-- Button -->
                          <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
        ...
        await sendMail({
          email: user.email,
          subject: emailSubject,
          message: `Your password reset link: ${resetPasswordUrl}. If you have not requested this email, then ignore it.`,
          html: emailHtml,
        });
