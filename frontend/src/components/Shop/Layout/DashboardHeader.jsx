...
const DashboardHeader = () => {
  ...
  return (
    <>
      <div className="w-full h-16 md:h-18 lg:h-20 bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-0 left-0 z-30 flex items-center justify-between px-4 md:px-6 shadow-sm">
        <div className="flex items-center">
          ...
          >
            <img
              src={logo}
              alt="Logo"
              className="w-auto h-14 md:h-14 object-contain scale-150 group-hover:scale-125 transition-transform duration-200"
            />
          </Link>
        </div>
      ...
      >
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute top-16 md:top-18 lg:top-20 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-2xl transform transition-all duration-300 ease-out ${
            isMobileMenuOpen
