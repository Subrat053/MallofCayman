...
export const generateInvoice = async (order) => {
  try {
    ...
    doc.text('Email: support@mallofcayman.com', 20, detailsY + 72);
    ...
    doc.setFontSize(9);
    doc.setFont('helvetica', 'normal');
    doc.text('support@mallofcayman.com', 20, footerY + 12);
    doc.text('www.mallofcayman.com', pageWidth/2, footerY + 12, { align: 'center' });
