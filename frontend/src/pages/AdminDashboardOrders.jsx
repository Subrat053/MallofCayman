          ...
          <div className="max-w-full">
            ...
            <div className="mb-4 sm:mb-6">
              <div className="flex items-center space-x-3 mb-2">
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-r from-green-500 to-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <HiOutlineShoppingBag className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                </div>
                <div>
                  <h1 className="text-xl sm:text-2xl 800px:text-3xl font-bold text-gray-900">
                    All Orders
                  </h1>
                  <p className="text-sm sm:text-base text-gray-600">Manage all platform orders</p>
                </div>
              </div>
            </div>

            {/* Stats Cards */}
            <div className="grid grid-cols-2 sm:grid-cols-2 800px:grid-cols-4 gap-3 sm:gap-4 800px:gap-6 mb-4 sm:mb-6">
              <div className={`${styles.card} p-3 sm:p-4`}>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 rounded-lg flex items-center justify-center order-1 sm:order-2 mb-2 sm:mb-0">
                    <HiOutlineShoppingBag className="h-5 w-5 sm:h-6 sm:w-6 text-primary-600" />
                  </div>
                </div>
              </div>
              ...
              <div className={`${styles.card} p-3 sm:p-4`}>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-lg flex items-center justify-center order-1 sm:order-2 mb-2 sm:mb-0">
              ...
              <div className={`${styles.card} p-3 sm:p-4`}>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-lg flex items-center justify-center order-1 sm:order-2 mb-2 sm:mb-0">
                    <MdPending className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-600" />
                  </div>
                </div>
              </div>
              ...
              <div className={`${styles.card} p-3 sm:p-4`}>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center order-1 sm:order-2 mb-2 sm:mb-0">
                    <AiOutlineDollarCircle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`${styles.card} p-3 sm:p-4 mb-4 sm:mb-6`}>
              <div className="flex flex-col gap-3 sm:gap-4">
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      ...
                      className={`${styles.input} w-full transition-all duration-300 ease-in-out hover:border-gray-400 focus:shadow-lg text-sm sm:text-base`}
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {/* Quick Sort Buttons - Hidden on mobile */}
                    <div className="hidden lg:flex items-center space-x-1 px-3 py-1 bg-gray-50 rounded-lg transition-all duration-200 ease-in-out">
                    ...
                    <button
                      ...
                      className={`inline-flex items-center px-3 sm:px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 ease-in-out shadow-sm ${
                        showFilters
                    ...
                    >
                      <FiFilter
                        className={`mr-1 sm:mr-2 h-4 w-4 transition-transform duration-300 ${
                          showFilters ? "rotate-180" : ""
                        }`}
                      />
                      <span className="hidden xs:inline">Filters</span>
                      {hasActiveFilters && (
                        <span className="ml-1 sm:ml-2 inline-flex items-center justify-center w-5 h-5 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">
                          {
                            [
                              statusFilter !== "All",
                              paymentStatusFilter !== "All",
                    ...
                    {hasActiveFilters && (
                      <button
                        ...
                        className="inline-flex items-center px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-all duration-300 ease-in-out shadow-sm"
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 sm:px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white text-sm font-medium rounded-lg hover:from-green-700 hover:to-green-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 ease-in-out shadow-sm"
                      title="Export filtered orders to CSV"
                    >
                      <FiDownload className="mr-1 sm:mr-2 h-4 w-4" />
                      <span className="hidden sm:inline">Export</span>
                      <span className="hidden md:inline"> CSV</span>
                      <span className="ml-1">({filteredRows.length})</span>
                    </button>
                  </div>
                </div>
                ...
                >
                  <div className="border-t border-gray-200 pt-3 sm:pt-4 mt-3 sm:mt-4 transform transition-all duration-300 ease-in-out">
            ...
            <div className={`${styles.card} overflow-hidden`}>
                ...
                <div className="divide-y divide-gray-100">
                  {filteredRows.length === 0 ? (
                    ...
                    filteredRows.map((order) => {
                      const orderData = adminOrders?.find((o) => o._id === order.id);
                      const canCancel = orderData && orderData.status !== "Cancelled" && orderData.status !== "Delivered";
                        ...
                        <div key={order.id} className="p-4 hover:bg-gray-50">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-mono text-primary-600 truncate" title={order.id}>
                                {getOrderNumber(order)}
                              </p>
                              <p className="text-xs text-gray-500 mt-1">{order.createdAt}</p>
                            </div>
                            <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${statusClass}`}>
                              <StatusIcon size={12} />
                          ...
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center space-x-1 text-sm">
                                <FiPackage size={14} className="text-gray-500" />
                                <span className="text-gray-700">{order.itemsQty} items</span>
                              </div>
                              <div className="font-semibold text-primary-600 flex items-center space-x-1">
                                <AiOutlineDollarCircle size={14} />
                          ...
                          <div className="flex items-center justify-end space-x-2 pt-2 border-t border-gray-100">
                            ...
                            {orderData && (
                              <button
                                className={`inline-flex items-center px-3 py-1.5 text-xs font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors ${downloadingInvoice === order.id ? "opacity-75 cursor-not-allowed" : ""}`}
                                onClick={() => handleDownloadInvoice(orderData)}
                                disabled={downloadingInvoice === order.id}
                              >
                                {downloadingInvoice === order.id ? (
                                  <FiLoader size={14} className="mr-1 animate-spin" />
                                ) : (
              ...
              <div className="hidden 800px:block h-[600px] w-full">
                <DataGrid
                  rows={filteredRows}
                  columns={columns}
                  pageSize={10}
          ...
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none text-sm sm:text-base"
                rows={3}
              />
            </div>
            <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 sm:gap-3">
              <button
                ...
                className="w-full sm:w-auto px-4 py-2.5 text-gray-600 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
