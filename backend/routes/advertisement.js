...
router.post(
  "/calculate-price",
  optionalSellerOrStoreManager,
  advertisementController.calculateAdvertisementPrice,
);
router.get(
  "/available-slots/:adType",
  optionalSellerOrStoreManager,
  advertisementController.getAvailableSlots,
);
router.get(
  "/active/:adType",
  advertisementController.getActiveAdvertisementsByType,
);
...
router.post(
  "/stripe/create-ad-payment-session",
  isSellerOrStoreManager,
  advertisementController.createStripeAdPaymentSession,
);
router.post(
  "/stripe/confirm-ad-payment",
  isSellerOrStoreManager,
  advertisementController.confirmStripeAdPayment,
);
