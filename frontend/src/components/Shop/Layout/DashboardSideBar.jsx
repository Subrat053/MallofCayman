...
const DashboardSideBar = ({ active }) => {
  ...
  const menuItems = [
    ...
    },
    {
      id: 24,
      title: "Store Manager",
      link: "/dashboard-store-manager",
      icon: FiUsers,
      badge: "$100",
      requiresSubscription: true,
      featureKey: null, // Always accessible with subscription - paid add-on service
    },
    {
      id: 16,
      title: "Shop Settings",
    ...
    },
    {
      ...
      badge: null,
      requiresSubscription: true,
      featureKey: null, // Always accessible with subscription - Payment, SEO, Policies
    },
    {
      id: 23,
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200/80 shadow-xl z-30 mobile-nav-blur">
        <div className="grid grid-cols-5 gap-1 px-2 py-2 safe-area-inset-bottom">
          ...
          {[
            ...
            menuItems.find((item) => item.id === 11), // Messages
            {
              id: "more",
              title: "More",
              icon: AiOutlineMenu,
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 20 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Advertisements
                      </h4>
                      <p className="text-sm text-gray-500">Manage your ads</p>
                    </div>
                    {active === 20 && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    )}
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 21 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Create Advertisement
                      </h4>
                      <p className="text-sm text-gray-500">New ad campaign</p>
                    </div>
                    {active === 21 && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    )}
                  ...
                  {/* Ad Pricing */}
                  <Link
                    to="/dashboard-advertisement-pricing"
                    onClick={() => setIsMobileSidebarOpen(false)}
                    className={`flex items-center p-4 transition-all duration-200 ${
                      active === 22
                        ? "bg-blue-50 border-r-4 border-blue-500"
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 22 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Ad Pricing
                      </h4>
                      <p className="text-sm text-gray-500">View ad rates</p>
                    </div>
                    {active === 22 && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    )}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <p className="text-sm text-gray-500">Manage videos</p>
                    </div>
                    {active === 9 && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    )}
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <p className="text-sm text-gray-500">Add new video</p>
                    </div>
                    {active === 10 && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    )}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 14 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Product Shipping
                      </h4>
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 24 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Store Manager
                      </h4>
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 16 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        Shop Settings
                      </h4>
                  ...
                  >
                    ...
                    <div className="ml-3 flex-1">
                      <h4
                        className={`font-semibold text-base ${
                          active === 23 ? "text-blue-900" : "text-gray-900"
                        }`}
                      >
                        HTML/CSS Editor
                      </h4>
                      <p className="text-sm text-gray-500">Custom styling</p>
                    </div>
